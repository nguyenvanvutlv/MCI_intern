...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Task',
            fields=[
                ('id_task', models.AutoField(primary_key=True, serialize=False, unique=True, verbose_name='ID Task')),
                ('name_task', models.CharField(max_length=50, verbose_name='Name Task')),
                ('description_task', models.TextField(blank=True, null=True)),
                ('create_date_task', models.DateField(default=django.utils.timezone.now, verbose_name='Create Date Task')),
                ('start_date_task', models.DateField(default=django.utils.timezone.now, verbose_name='Start Date Task')),
                ('end_date_task', models.DateField(default=django.utils.timezone.now, verbose_name='End Date Task')),
                ('status_task', models.CharField(choices=[('1', 'In Progress'), ('2', 'Completed'), ('3', 'Pending'), ('4', 'Cancel')], default='1', max_length=1)),
                ('is_activate', models.BooleanField(default=True)),
                ('rank_task', models.IntegerField(blank=True, null=True)),
                ('manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_manager_task', to=settings.AUTH_USER_MODEL, verbose_name='ID Manager')),
                ('process', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_task_process', to='app.process', verbose_name='ID Root Process')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_project_task', to='app.project', verbose_name='ID Project')),
            ],
        ),
        migrations.CreateModel(
            name='TaskEditable',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_activate', models.BooleanField(default=True)),
                ('id_task', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_task_editable', to='app.task', verbose_name='ID Task')),
                ('id_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_user_editable_task', to=settings.AUTH_USER_MODEL, verbose_name='ID User')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_project_role', to='app.project', verbose_name='ID Project')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_activate', models.BooleanField(default=True)),
                ('id_project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_project_editable', to='app.project', verbose_name='ID Project')),
                ('id_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_user_editable_project', to=settings.AUTH_USER_MODEL, verbose_name='ID User')),
            ],
        ),
        migrations.CreateModel(
            name='ProcessEditable',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_activate', models.BooleanField(default=True)),
                ('id_process', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_process_editable', to='app.process', verbose_name='ID Process')),
                ('id_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_user_editable', to=settings.AUTH_USER_MODEL, verbose_name='ID User')),
            ],
        ),
        migrations.AddField(
            model_name='process',
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_project_process', to='app.project', verbose_name='ID Project'),
        ),
        migrations.AddField(
            model_name='process',
            name='root_process',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_root_process', to='app.process', verbose_name='ID Root Process'),
        ),
        migrations.CreateModel(
            name='Discuss',
            fields=[
        ...
        migrations.CreateModel(
            name='AssignProjectProcess',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_activate', models.BooleanField(default=True)),
                ('id_assign', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_assign', to='app.assignproject', verbose_name='ID Assign Project')),
                ('id_process', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_process_assign', to='app.process', verbose_name='ID Process')),
            ],
        ),
        migrations.AddField(
            model_name='assignproject',
            name='project',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_project_assign', to='app.project', verbose_name='ID Project'),
        ),
        migrations.AddField(
            model_name='assignproject',
            name='role_assign',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_role_assign', to='app.role', verbose_name='ID Role'),
        ),
        migrations.AddField(
            model_name='assignproject',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='id_user_assign', to=settings.AUTH_USER_MODEL, verbose_name='ID User'),
        ),
    ]
